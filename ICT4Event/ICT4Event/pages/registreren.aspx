...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>Her-Wachtwoord:    <asp:TextBox ID="regi_herwachtwoord" runat="server"></asp:TextBox></p>
    <p><asp:Button ID="btn_registeren" runat="server" Text="Registeren" /></p>
        
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <h1>Activeren</h1>
    <p>Activerings code: <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></p>
    <p><asp:Button ID="btn_actieveren" runat="server" Text="Activeren" /></p>
</asp:Content>
